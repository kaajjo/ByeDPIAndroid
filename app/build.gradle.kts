...
dependencies {
    implementation(files("../app/libs/tun2socks.aar"))
...
abstract class BuildTun2Socks : DefaultTask() {
    ...
    fun buildTun2Socks() {
        ...
        val tun2socksDir = projectDir.resolve("../app/libs/tun2socks")
        val tun2socksOutput = projectDir.resolve("../app/libs/tun2socks.aar")
